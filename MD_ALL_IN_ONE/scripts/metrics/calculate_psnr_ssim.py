...
if __name__ == '__main__':
    ...
    parser.add_argument('--gt', type=str, default='/root/autodl-tmp/unsupervised deraining/unsupervised/datasets/ALL_IN_ONE_5T_TEST/GoPro/target', help='Path to gt (Ground-Truth)')
    parser.add_argument('--restored', type=str, default='/root/autodl-tmp/unsupervised deraining/All_in_One/test_results/deblur', help='Path to restored images')
